...
PanoJS.CONTROL_IMAGE_ZOOMIN   = "../../../js/images/32px_plus.png";
PanoJS.CONTROL_IMAGE_ZOOM11   = "../../../js/images/32px_11.png";
PanoJS.CONTROL_IMAGE_ZOOMOUT  = "../../../js/images/32px_minus.png";
PanoJS.CONTROL_IMAGE_MAXIMIZE = "../../../js/images/32px_show.png";

PanoJS.CONTROL_IMAGE_ZOOMIN_TOUCH   = "../../../js/images/64px_plus.png";
PanoJS.CONTROL_IMAGE_ZOOM11_TOUCH   = "../../../js/images/64px_11.png";
PanoJS.CONTROL_IMAGE_ZOOMOUT_TOUCH  = "../../../js/images/64px_minus.png";
PanoJS.CONTROL_IMAGE_MAXIMIZE_TOUCH = "../../../js/images/64px_show.png";
...
if (isClientTouch()) {
  PanoJS.CONTROL_ZOOMIN.style   = PanoJS.CONTROL_STYLE + " top: 15px;  left: 15px;  width: 48px;";
  PanoJS.CONTROL_ZOOM11.style   = PanoJS.CONTROL_STYLE + " top: 75px;  left: 15px;  width: 48px;";
  PanoJS.CONTROL_ZOOMOUT.style  = PanoJS.CONTROL_STYLE + " top: 135px; left: 15px;  width: 48px;";
  PanoJS.CONTROL_MAXIMIZE.style = PanoJS.CONTROL_STYLE + " top: 15px;  right: 15px; width: 48px;";
}

if (isClientPhone()) {
  PanoJS.CONTROL_ZOOMIN.style   = PanoJS.CONTROL_STYLE + " top: 30px;  left: 30px;  width: 48px;";
  PanoJS.CONTROL_ZOOM11.style   = PanoJS.CONTROL_STYLE + " top: 100px; left: 30px;  width: 48px;";
  PanoJS.CONTROL_ZOOMOUT.style  = PanoJS.CONTROL_STYLE + " top: 170px; left: 30px;  width: 48px;";
  PanoJS.CONTROL_MAXIMIZE.style = PanoJS.CONTROL_STYLE + " top: 30px;  right: 30px; width: 48px;";
}
